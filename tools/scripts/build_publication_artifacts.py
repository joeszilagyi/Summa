...
from tools.scripts.build_static_knowledge_tree import StaticKnowledgeTreeBuildError, build_static_knowledge_tree  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", required=True, help="Directory that will receive export, presentation, and static outputs.")
...
def main() -> int:
    ...
    except (PublicationBuildError, StaticKnowledgeTreeBuildError) as exc:
